...
type:
  - article
concepts:
  - "[[Concepts/Cosmogramme|Cosmogramme]]"
  - "[[Concepts/Théorie de l'Acteur Réseau|Théorie de l'Acteur Réseau]]"
création: 2026-09-03
urls:
  - https://pure.itu.dk/en/publications/techno-animism-in-japan-shinto-cosmograms-actor-network-theory-an/
cover:
tags:
relations:
description: Le techno-animisme shinto permet d'imaginer une Actor-Network Theory dans laquelle les relations entre humains et non-humains ne sont pas seulement matérielles et agentielles, mais également affectives, esthétiques, spirituelles et capables d’enchantement.
apa:
---
