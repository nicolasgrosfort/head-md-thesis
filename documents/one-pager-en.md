...
**In what ways do the interface metaphors of autonomous AI agents shape our way of being in the world - and to what extent could an animist ontology allow us to imagine alternatives?**

#### Sub-questions

1. How do the interface metaphors of autonomous AI agents organise our way of entering into relation with them?
2. In what ways could an animist ontology allow us to rethink our relationship with autonomous AI agents?
3. How does the torii mediate the relationship with alterity?
...
1. **Reflexive practice**: auto-ethnographic journal of a daily interaction with an autonomous AI agent (Hermès).
...
| **October**   | Writing, layout                                | Interim presentation, Web device        | Geneva   |
...
A selection of the 10 most relevant references.

| **Reference**                                                                                                                                                                                                                             | **Author**                       | **Domain**              | **Type** |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------- | ----------------------- | -------- |
...
| [Plaything (Black Mirror)](https://en.wikipedia.org/wiki/Plaything_(Black_Mirror))                                                                                                                                                        | Charlie Brooker                  | Agentivity              | Film     |
| [My Neighbor Totoro](https://fr.wikipedia.org/wiki/Mon_voisin_Totoro)                                                                                                                                                                     | Hayao Miyazaki                   | Alterity                | Film     |
